                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <script>
                                                            jQuery(document).ready(function() {
                                                                ...
                                                                jQuery(".pay_paypal").click(function(event){ 
                                                                    action_url = "https://www.paypal.com/cgi-bin/webscr";
                                                                    return_url = "https://werescued.org/help/return.php?form=<?php echo $slug;?>";
                                                                    cancel_url = "https://werescued.org/help/return.php?form=<?php echo $slug;?>";
                                                                    event.preventDefault();
                                                                    ...
                                                                    var newForm = $('<form>', {
                                                                        ...
                                                                        'name': 'business',
                                                                        'value': 'rajnish123saini@gmail.com',
                                                                        'type': 'hidden'
                                                                    })); 
                                                                    if(jQuery("#select_payment_type").val() == "onetime"){
                                                                        jQuery(newForm).append(jQuery('<input>', {
                                                                            'name': 'amount',
                                                                            'value': parseFloat(jQuery("#final_amount").val())/100,
                                                                            'type': 'hidden'
                                                                        }));
                                                                        jQuery(newForm).append(jQuery('<input>', {
                                                                            'name': 'no_shipping',
                                                                    ...
                                                                    jQuery(newForm).append(jQuery('<input>', {
                                                                        'name': 'cmd',
                                                                        'value': cmd,//_xclick-subscriptions
                                                                        'type': 'hidden'
                                                                    }));
                                                                    jQuery(newForm).append(jQuery('<input>', {
                                                                        'name': 'currency_code',
                                                        ...
                                                        <div step="2" id="pay_paypal" class="btn btn-success next pay_paypal" style="
