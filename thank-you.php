        ...
        <div class="stripe-donation-info">
            <div class="stripe-left-content">
                ...
                <div class="stripe-bottom-content">
                    ...
                    <h3>Thank you.</h3>
                    <p class="text-line-clamp-6"></p><p class="text-line-clamp-6">Thank you so much for being one of the few today and stepping up with your important help</p>
                    <br/><br/>
                </div>
            </div>
        </div>
...
if(isset($_GET['name']) && $_GET['name']!=""){
	...
	send_stripe_email($config, $customer_name);
}
                                                            ...
                                                            <td colspan="12">
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding-top:34px;text-align: center;">
                                                                       <tbody>
                                                                           <tr>
                                                                              <td>
                                                                                    <h3 style="font-family: Source Sans Pro,sans-serif;font-style: normal;font-weight: normal;font-size: 40px;line-height: 50px;text-align: center;letter-spacing: 0.05em;margin-top: 0px;margin-bottom: 10px;color: #EE943A;">Thanks for help</h3>
